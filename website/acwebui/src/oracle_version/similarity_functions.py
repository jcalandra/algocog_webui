...
from acwebui.src.parameters import GRAPH_COMPARISON, AUDIBLE_THRESHOLD, DIFF_DYNAMIC, DIFF_FOURIER, EUCLID_DISTANCE, \
    DIFF_CONCORDANCE
...
def true_mat(i_hop_a, i_hop_b, i_hop_c, j_mat, prev2_mat, s_tab, params):
...
def comparison(i_hop, teta, s_tab, v_tab, mat, path, params):
...
def dissimilarity(i_hop, s_tab, v_tab, params):
...
def true_mat_rep(m_i_hop_a, s_i_hop_b, m_i_hop_c, j_mat, prev2_mat, params):
...
def comparison_rep(i_hop, teta, s_tab, v_tab, mat_rep, params):
